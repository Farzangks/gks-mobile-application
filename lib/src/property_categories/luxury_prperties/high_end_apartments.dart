...
class HighEndApartments extends StatefulWidget {
  const HighEndApartments({super.key});

  @override
  State<HighEndApartments> createState() => _HighEndApartmentsState();
}

class _HighEndApartmentsState extends State<HighEndApartments> {
