...
class IndustrialUnits extends StatefulWidget {
  const IndustrialUnits({super.key});

  @override
  State<IndustrialUnits> createState() => _IndustrialUnitsState();
}

class _IndustrialUnitsState extends State<IndustrialUnits> {
