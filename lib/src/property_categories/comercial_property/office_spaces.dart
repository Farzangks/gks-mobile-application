...
class OfficeSpaces extends StatefulWidget {
  const OfficeSpaces({super.key});

  @override
  State<OfficeSpaces> createState() => _OfficeSpacesState();
}

class _OfficeSpacesState extends State<OfficeSpaces> {
