...
class CommercialLandDetailsScreen extends StatefulWidget {
  CommercialLandDetailsScreen({super.key});

  @override
  State<CommercialLandDetailsScreen> createState() => _CommercialLandDetailsScreenState();
}

class _CommercialLandDetailsScreenState extends State<CommercialLandDetailsScreen> {
  ...
  void initState() {
    ...
    propertyController.getPropertiesByCategories(context,'⁠Commercials Land');
    super.initState();
  }
  ...
  final List<Map<String, dynamic>> services = [
    {
      ...
      'imagePath': "assets/gks/comercial_land.png",
    },
    {
      'title': "Demo2",
      'rating': 4.5,
  ...
  final List<Map<String, String>> properties = [
    {
      ...
      "image": 'assets/gks/commercial-land.jpg',
    },
    {
      "price": "₹71 L - ₹1.07 Crs",
      "details": "2, 3 BHK",
      ...
      "location": "Devanahalli",
      "image": 'assets/gks/commercialland-tapovan.jpg',
    },
  ];

  final List<String> staticBannerList = [
    'assets/gks/images (1).jpeg',
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return CarouselSliderView(
                      bannerList: carouselController.commercialUrls.isEmpty
                          ? staticBannerList // Fallback to static list if API fails
                          : carouselController.commercialUrls,
